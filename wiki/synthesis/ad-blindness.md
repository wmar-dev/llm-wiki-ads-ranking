---
title: "Ad Blindness and Banner Blindness"
type: "synthesis"
sources:
  - "web/en-wikipedia-org-wiki-banner-blindness.html"
  - "web/www-nngroup-com-articles-banner-blindness-old-and-new-findings.html"
status: "current"
created: "2026-06-09"
...
Three ad-like traits cause elements to be ignored:
...
|---|---|---|
| Ad avoidance | Users ignore known ad locations (top, right rail) | Harder to ignore inline ads due to small screen |
| Ad detection | Visual differences (color, shape) make ads easy to spot and skip | Less visible context makes it harder to distinguish ads from content |
...
*Inference:* Banner blindness is not cost-free. While users retrieve similar amounts of relevant information regardless of ads, they:

- Take **significantly longer** completing tasks when ads are present
- Report **higher frustration and annoyance**
...
|---|---|---|
| Native advertising | Blend ad format with surrounding content | May reduce transparency; regulated disclosure required |
| Personalization | Serve relevant ads based on user data | Raises privacy concerns; can feel "creepy" |
| Social media ads | Leverage peer trust signals | Context collapse; platform-specific |
...
- To what extent does ad blindness reduce the economic efficiency of display advertising relative to native or search ads?
- Can ad-blindness effects be quantified as a discount factor on eCPM for different ad formats and placements?
